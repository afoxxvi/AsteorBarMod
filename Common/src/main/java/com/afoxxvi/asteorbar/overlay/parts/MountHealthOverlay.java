...
public class MountHealthOverlay extends BaseOverlay {
    private void draw(GuiGraphics guiGraphics, int left, int top, int right, int bottom, float health, float healthMax, boolean flip) {
        ...
        drawBound(guiGraphics, left, top, right, bottom, AsteorBar.config.mountHealthBoundColor(), AsteorBar.config.mountHealthBoundColor2());
        drawEmptyFill(guiGraphics, left + 1, top + 1, right - 1, bottom - 1, AsteorBar.config.mountHealthEmptyColor());
        drawFillFlip(guiGraphics, left + 1, top + 1, right - 1, bottom - 1, healthWidth, AsteorBar.config.mountHealthColor(), AsteorBar.config.mountHealthColor2(), flip);
